...
[![Platform](https://img.shields.io/badge/Platform-Android_14+-3DDC84?style=flat&logo=android&logoColor=white)](https://developer.android.com)
...
[![Architecture](https://img.shields.io/badge/Architecture-Clean_MVVM-FF6F00?style=flat)]()
[![Local Persistence](https://img.shields.io/badge/Database-Room_2.7.0-4CAF50?style=flat&logo=sqlite&logoColor=white)](https://developer.android.com/training/data-storage/room)
[![Offline First](https://img.shields.io/badge/Offline-100%25_Local_Processing-009688?style=flat)]()
[![Hardware Acceleration Target](https://img.shields.io/badge/NPU_Target-Qualcomm_Hexagon_QNN-E91E63?style=flat)]()
[![Hackathon Prototype](https://img.shields.io/badge/Status-Hackathon_Prototype-orange?style=flat)]()
...
Nidan AI transforms consumer smartphones into smart, offline point-of-care screening tools. By pairing multimodal sensor capture (computer vision viewfinder guides for conjunctival pallor and MUAC arm circumference, alongside multilingual voice triage) with a **deterministic clinical rule engine**, Nidan AI delivers instant, objective **🟢 GREEN (Low Risk)**, **🟡 YELLOW (Moderate Risk)**, and **🔴 RED (High / Urgent Risk)** triage recommendations right in the field. All patient demographics and screening histories are stored in a local, encrypted SQLite database, ready for seamless local wireless handover to Primary Health Centre (PHC) doctors via the simulated **iQOO Office Kit** bridge.
...
graph TB
    ...
    ViewModel_Layer --> AI_Abstraction_Layer
...
sequenceDiagram
    ...
    participant Doctor as PHC Medical Officer
...
- Android physical device or emulator running Android 7.0+ (ARM64 / x86_64)
